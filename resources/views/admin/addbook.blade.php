        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="/addbookAction" method="post" enctype="multipart/form-data">
              @csrf
                <div class="card-body">
                 ...
                 <textarea name="description" id="description" class="form-control" name="description"></textarea>
                  ...
                  <div class="form-group">
                    <label for="pulishername">Publisher Name</label>
                    <input type="text" class="form-control" id="pulishername" placeholder="Enter Publisher Name" name="publishername">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="exampleInputFile" name="inputFileUpload">
